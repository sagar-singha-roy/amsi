          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Asset Management
                <span className="block text-blue-300">Society, India</span>
              </h1>
              <p className="text-xl text-blue-100 max-w-2xl">
                Advancing asset management excellence through collaboration, education, 
                and innovation across India and globally.
              </p>
            </div>
