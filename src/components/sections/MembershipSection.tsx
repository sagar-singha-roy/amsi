      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-blue-700 max-w-3xl mx-auto">
            Join the Asset Management Society, India and become part of a
            growing community of professionals dedicated to advancing asset
            ...
            <table className="min-w-full bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <tbody className="divide-y divide-blue-100">
                {membershipFeeStructure.map((item, index) => (
                  ...
                  >
                    <td className="py-4 px-6 text-blue-800 font-medium">
                      {item.type}
                    </td>
        ...
        <div className="mb-16">
          ...
          <p className="text-blue-700 text-center mb-8">
            There will be the following classes of Members: Student member,
            Individual member, Corporate member, Life, Honorary, or such other
            class as may be determined from time to time by the Society. The
            class to which a Member belongs is herein referred to as their
            status.
          </p>
              ...
              >
                ...
                <div className="space-y-4">
                  {memberClass.description.map((paragraph, pIndex) => (
                    <p key={pIndex} className="text-blue-700">
                      {paragraph}
                    </p>
                  ))}
                </div>
        ...
        <div className="mb-16">
          <h3 className="text-3xl font-bold text-blue-900 mb-4 text-center">
            Evidence of Qualification for Membership
          </h3>
          <div className="bg-white rounded-xl p-8 shadow-lg border-l-4 border-blue-600">
            <p className="text-blue-700">
              In respect of any application for Membership or in the event that
              additional classes of Members are created, the executive council
              may require the application to be accompanied by such proof,
              information or evidence demonstrating satisfaction, as the
              executive council reasonably determines, as to qualification for
              the type of Membership, in respect of which the application is
              made.
            </p>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border-l-4 border-blue-600">
            <p className="text-blue-700">
              Unless otherwise determined by the executive council, the
              executive council or their nominated delegate shall admit or
              reject the application in accordance with any guidelines
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://www.amsi.net.in/membership-application/"
